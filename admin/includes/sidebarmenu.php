                           ...
                           <div class="menu">
									<ul id="menu" >
									 ...
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Tour Packages</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Safety Guide</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="create-sguide.php">Create</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-sguide.php">Manage</a></li>
										  </ul>
										</li>
